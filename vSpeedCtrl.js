/**
 * Created by EXTYT1 on 17/07/2016.
 */
app.controller("vSpeedCtrl", ['$scope', function ($scope) {
    $scope.title = "Train Simulation Exercise";
    $scope.dot= "Yellow dot travels at varied speed";
    $scope.dot1 = "Purple dot travels at const speed";
    ...
    function ready(error, xml) {
        ...
        for (var i = 0; i < 24; i++){
            ...
            var time = (ARRAY_LENGTHS[i]/ARRAY_SPEED[i])*1000;
